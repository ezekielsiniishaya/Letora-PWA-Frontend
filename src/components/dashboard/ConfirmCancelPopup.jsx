export default function ConfirmCancelPopup({ onClose, onConfirm }) {
  return (
    <div className="fixed inset-0 bg-black/50  z-[9999]" onClick={onClose}>
      <div
        className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-lg p-6 w-full max-h-[50vh] text-center"
      ...
      >
        ...
        <p className="text-[14px] font-medium w-[90%] mx-auto text-[#333333] mb-2">
          Are you sure you want to cancel your shortlet booking? 😳
        </p>
        <p className="text-[12px] text-[#505050] w-[90%] mx-auto font-medium mb-6">
