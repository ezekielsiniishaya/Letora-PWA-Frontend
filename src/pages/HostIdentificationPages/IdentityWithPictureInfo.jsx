  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-[#F9F9F9] px-[20px]">
      ...
      <div className="w-full max-w-sm mt-[26px]">
        ...
        <div className="mt-[41px] text-[#333333] px-[12px] rounded-lg bg-white flex flex-col items-center h-[366px]">
          <img
            src="/images/verify.png"
            alt="ID Example"
            className="w-[309px] h-[202px] mt-[17px] object-cover rounded-[5px]"
          />
          <h3 className="font-medium mt-[15px] text-[15px] ">
            Upload Your ID Card with Face Visible
          </h3>
          <p className="text-[13px] w-[309px] text-center mt-[11px] text-[#505050]">
