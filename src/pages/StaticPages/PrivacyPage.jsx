  ...
  const privacyPolicy = [
    ...
    },
    {
      ...
      content: [
        ...
        "- Fraud detection: Verifying identities, detecting suspicious activity.",
        "- Customer support: Responding to queries, resolving complaints.",
        "- Communications: Sending confirmations, reminders, updates.",
        "- Marketing and promotions: With user consent, sending promotional emails or platform updates.",
        "- Compliance: Fulfilling tax, anti-money laundering, and legal obligations.",
      ],
    },
    {
      ...
      content: [
        ...
        " - Identify verification companies (e.g., Smile Identity)",
    ...
    },
    {
      ...
      content: [
        ...
        "- Right to Deletion – You can request deletion (subject to exceptions).",
        ...
        "",
        "To exercise any of your rights, contact: privacy@letora.ng",
      ],
    },
    {
      section: "10. Cookies and Tracking Technologies",
      content: [
        "We use cookies to enhance user experience. Types of cookies:",
        "- Essential cookies – For platform functionality",
        "- Analytics cookies – For traffic monitoring",
        "- Preference cookies – For saving settings",
    ...
    },
    {
      ...
      content: [
        "Our platform is not intended for users under 18 years of age. We do not knowingly collect data from minors. If we discover that a minor has submitted data, we will delete it immediately.",
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "Email: privacy@letora.ng",
      ],
    },
    {
      section: "15. Governing Law and Jurisdiction",
      content: [
        "This Privacy Policy shall be governed by the laws of the Federal Republic of Nigeria, and any disputes arising shall be subject to the exclusive jurisdiction of Nigerian courts.",
      ],
    },
  ];
